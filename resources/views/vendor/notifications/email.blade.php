                ...
                <tr>
                    <td style="border-radius: 8px 8px 0 0; position: relative; text-align:center;">
                        <a href="{{ url('/login') }}" target="_blank">
                            <img src="{{ URL::asset('public/images/logo/logo.png') }}" alt="Orniverse" width="150" border="0" style="padding:20px 20px 5px 20px; width:150px; height: auto;"><br>
                        </a>
                    </td>
                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6C6C6C;">
                                                            <span style="font-size: 17px;"><br><b>Hello!</b></span>, <br><br>
                        ...
                        <table width="576" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#6c6c6c;padding:10px">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6c6c6c;">
                                            <a href="{{ $actionUrl }}" class="" style="color: #fff;background-color: #035293; border-color: #035293;
                                    ...
                                    <td style="padding:0 10px 20px 10px;">
                                        <table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 13px; color: #6C6C6C;">
                                                             <br>
