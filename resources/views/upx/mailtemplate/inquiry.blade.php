                                    ...
                                    <div
                                        ...
                                        style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6C6C6C;">
                                             ...
                                             <span style="font-size: 17px;"><br>Hello {{--{{ $name }}--}} ,
                                                 ...
                                                 <p>You have new inquiry, please check below details :</p>

                                             {{--<p>

                                                New inquiry details mention below :
                                            ...
                                            <p style="font-size: 14px;">
                                                ...
                                                <b>Contact Number : </b> {{ $data['contactno'] }} <br>

                                                <b>Shipper Address : </b> {{ $data['shipper_address'] }} <br>

                                                @if($data['service'] != 3)

                                                <b>Length (cm) : </b> {{ $data['length'] }} <br>

                                                <b>Width (cm) : </b> {{ $data['width'] }} <br>

                                                <b>Height (cm) : </b> {{ $data['height'] }} <br>

                                                <b>weight (kg) : </b> {{ $data['weight'] }} <br>

                                                @endif

                                                <b>Country  : </b> {{ $data['getcountry']['name'] }} <br>
