<html>
	...
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,600,300' rel='stylesheet' type='text/css'>
												...
												<tr>
													...
													<td>
														...
														<div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6C6C6C;">
															...
															<span style="font-size: 17px;"><br>Dear {{ $name}}</span>, <br><br>

															Your account has been created by United Parcel Xpress admin. Kindly click on the below link to verify your email address and generate new password!
								...
								<tr>
									...
									<td>
										...
										<div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6c6c6c;">
											...
											<a href="{{$url}}" class="" style="color: #fff;
		...
		border-radius: 4px;">Generate Password</a>
