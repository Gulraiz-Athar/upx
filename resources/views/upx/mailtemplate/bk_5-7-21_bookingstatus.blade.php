				...
				<tr>
					...
					<td style="border-radius: 8px 8px 0 0; position: relative; text-align:center;">
						...
						<a href="{{ url('/login') }}" target="_blank">
							...
							<img src="{{ URL::asset('public/images/logo/logo.png') }}" alt="Orniverse" width="150" border="0" style="padding:20px 20px 5px 20px; width:150px; height: auto;">
												...
												<tr>
													...
													<td>
														...
														<div style="font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 14px; color: #6C6C6C;">
															...
															<span style="font-size: 17px;"><br>Dear @if($data['usertype'] == 'sender') 

{{ $data['data']['addressessender']['name'] }} {{ $data['data']['addressessender']['lastname'] }} 

@endif 

@if($data['usertype'] == 'receiver')

{{ $data['data']['addressesreceiver']['name'] }} {{ $data['data']['addressesreceiver']['lastname'] }}

@endif</span>, <br><br>

															<b>Tracking number : </b> {{ $data['data']['tracking_number'] }} <br>

															@if($data['usertype'] == 'sender')

															<p>{{ $data['data']['tracking_number'] }}   is {{ $data['data']['logstatus']['status'] }} at {{ date('d M Y H:i A',strtotime($data['data']['created_at'] ))}}. </p>
															...
															<p>
																...
																Your order is {{ $data['data']['logstatus']['status'] }} at {{ date('d M Y H:i A',strtotime($data['data']['created_at'] ))}}.
