...
<header class="clearfix">
    ...
    <div style="width: 100%; height: 150px;">
        ...
        <div style="width: 30%; float: left; text-align: left; font-size: 14px; word-wrap: break-word;">
            ...
            @if(!empty($booking->addressesreceiver->postalcode))
...
<main>
    <table>
        ...
        <tr>
            <td colspan="5">Volumetric Weight:</td>
            <td>{{ $booking->volumetric_weight }} Kg</td>
        </tr>
        @if($booking->service_id == 1)
            <tr>
                <td colspan="5">Consignment Value:</td>
                <td>&#163; {{ $booking->final_consignment_amt }} </td>
            </tr>
        @endif
        <tr>
            <td colspan="5"> Insure AMT:</td>
        ...
        <tr>
            <td colspan="5" class="grand total">Final Price (GBP):</td>
