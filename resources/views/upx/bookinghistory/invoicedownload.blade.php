    ...
    <div style="width: 100%; height: 150px;">
        ...
        <div style="width: 35%; float: left; text-align: left; font-size: 14px; word-wrap: break-word;">
            ...
            @if(!empty($booking->addressessender->address3))
                {{ $booking->addressessender->address3 }},<br>
            @endif
        ...
        <div style="width: 30%; float: left; text-align: left; font-size: 14px; word-wrap: break-word;">
            ...
            @if(!empty($booking->addressesreceiver->address3))
                {{ $booking->addressesreceiver->address3 }},<br>
            @endif
...
<main>
    <table>
        ...
        <tbody>
        <tr>
            <td  class="borderpoint">Service:</td>
            <td class="borderpoint">{{ $booking->service->name  }}</td>
        </tr>

        @if($booking->service_type && $booking->service_id == 1)
            <tr>
                <td>Service Type:</td>
        ...
        @endif
        <tr>
            <td  style=" width: 80%">Package Info:</td>
        ...
        @if($booking->service_id == 1)
            <tr>
                ...
                <td>&#163; {{ $booking->final_consignment_amt }} </td>
            </tr>
        @endif
        <tr>
            <td > Insure AMT:</td>
        ...
        <tr>
            <td >Packaging Charge (GBP):</td>
            <td>&#163; {{ $booking->packing_charge_amt }}</td>
        </tr>
        <tr>
            <td >Duties and Taxes (GBP):</td>
            <td>&#163; {{ $booking->tax_amt }}</td>
        </tr>
        <tr>
            <td  class="grand total">Total Price (GBP):</td>
...
<div class="maintermscondition " style="page-break-before:always; height: 50px;">
