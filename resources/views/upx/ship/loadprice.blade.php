<div class="box box-primary">
    <ul class="list-group mb-3 custom-list-group">
        ...
        <li class="list-group-item d-flex justify-content-between lh-condensed">
            ...
            <span class="text-muted">{{ $volumnmetricweight }}Kg</span>
        </li>
        <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
        ...
        <li class="list-group-item d-flex justify-content-between lh-condensed">
            ...
            <strong> &#163; {{ $consignmentfinalamt }}  </strong>
        </li>
        <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
        ...
        @else
            <li class="list-group-item sub-padding d-flex justify-content-between">
                <span>Total (GBP) : </span>
                <strong>&#163; {{ round($finalprice,2) }} </strong>
            </li>
            <li class="list-group-item sub-padding d-flex justify-content-between lh-condensed">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <input type="number" min="0" name="discount_amt" id="discount_amt" class="form-control" value="0">
                    </div>
                </div>
            </li>
            <li class="list-group-item sub-padding d-flex justify-content-between lh-condensed">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" name="packing_charge_amt" class="form-control packing_charge_amt" id="packing_charge_amt" value="0">
                    </div>
                </div>
            </li>
            <li class="list-group-item sub-padding d-flex justify-content-between lh-condensed">
            ...
            <li class="list-group-item sub-padding d-flex justify-content-between">
                @if($book == 0)
                    <span style="color: red">You have exceeded the booking limit  &#163; {{ auth()->user()->booking_limit }}</span>
                @else
                    <button class="btn btn-primary bookingbutton" type="submit"><i class="fa fa-bookmark" aria-hidden="true"></i> Book <span class="bookingspin"></span></button>
                @endif
...
<script type="text/javascript">
    ...
    $('body').on('keyup','#discount_amt,#packing_charge_amt,#tax_amt',function(){
        if($.isNumeric($(this).val()) || $(this).val().length === 0 ){
            var disamount = $("#discount_amt").val()
            var discount_amt = Math.abs(disamount);
