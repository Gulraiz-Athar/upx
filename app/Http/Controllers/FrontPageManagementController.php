...

{
...

    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                });*/ //code commented on 13-10-2022 due to sendgrid issue
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                if ($data) {
                    ...
                    $data = Inquiry::where('email',$input['email'])->with('getcountry')->orderby('id','desc')->first()->toArray();

                    try {
                        Mail::to($adminemail)->send(new Quoteinquirty($data,  $email, $adminname));
                    ...
                    //     }
                        ...
                        $arr = array('status' => 200, 'msg' => "mail not send");
                    }
    ...
    {
        return view('front.terms_condition.index');
    }
