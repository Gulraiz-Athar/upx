              ...
              if($request->type == 'upx_price'){
                  ...
                  if(!empty($priceslab)){
                          if($request->pricetype == "price"){
                            $priceslab->update(['upx_price'=>abs($request->price)]);  
                          } 
                          if($request->pricetype == "handling"){
                            $priceslab->update(['handling_price'=>abs($request->price)]);  
                          }
                      ...
                      $newprice->weight = 1;
                      if($request->pricetype == "price"){
                        $newprice->upx_price = abs($request->price);
                      }
                      if($request->pricetype == "handling"){
                        $newprice->handling_price = abs($request->price);
                      }
                      $newprice->save();
                  }
              }
               ...
               if($request->type == 'agent_price'){
                  ...
                  if(!empty($apriceslab)){
                      if($request->pricetype == "price"){
                          $apriceslab->update(['agent_price'=>abs($request->price)]);
                      }
                      if($request->pricetype == "handling"){
                        $apriceslab->update(['handling_price'=>abs($request->price)]);
                      }
                      ...
                      if($request->pricetype == "price"){
                        $anewprice->agent_price = abs($request->price);
                      }
                      if($request->pricetype == "handling"){
                        $anewprice->handling_price = abs($request->price);
                      }
                      $anewprice->save();
                  }
              }
